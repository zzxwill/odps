...
目前MaxCompute开放的计算任务类型有SQL、UDF、MapReduce、Graph及[机器学习](https://data.aliyun.com/product/learn)作业。其中SQL（不包括UDF）计算任务已经收费，New SQL（MaxCompute2.0）任务在2018年5月底启动收费。其他类型暂无收费计划。
