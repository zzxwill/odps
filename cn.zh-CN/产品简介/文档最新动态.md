...
|2018.11.03|将Java SDK、Python SDK和PyODPS DataFrame自定义函数中使用第三方包三篇文档移动到SDK参考目录|体验优化|将用户指南中的Java SDK、Python SDK和PyODPS DataFrame自定义函数中使用第三方包三篇文档统一移动到SDK参考目录|所有|[Java SDK](../../../../cn.zh-CN/SDK 参考/Java SDK.md#)、[Python SDK](../../../../cn.zh-CN/SDK 参考/Python SDK.md#)、[../../../../dita-oss-bucket/SP\_76/DNodps1830562/ZH-CN\_TP\_15204.md\#](../../../../cn.zh-CN/用户指南/PyODPS/DataFrame/PyODPS DataFrame自定义函数中使用第三方包.md#)|
