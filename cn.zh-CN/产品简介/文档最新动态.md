...
|2018.11.15|处理非结构化数据目录更新为外部表|体验优化|处理非结构化数据目录更新为外部表|所有|[外部表](../../../../cn.zh-CN/用户指南/外部表/前言.md#)|
...
|2018.11.08|新增与MySQL内建函数对照表|体验优化|帮助您根据MySQL内建函数查找对应的MaxCompute内建函数。|所有|[与MySQL内建函数对照表](../../../../cn.zh-CN/用户指南/SQL/内建函数/与MySQL内建函数对照表.md#)|
...
|2018.11.03|将Java SDK、Python SDK和PyODPS DataFrame自定义函数中使用第三方包三篇文档移动到SDK参考目录|体验优化|将用户指南中的Java SDK、Python SDK和PyODPS DataFrame自定义函数中使用第三方包三篇文档统一移动到SDK参考目录|所有|[Java SDK](../../../../cn.zh-CN/SDK 参考/Java SDK.md#)、[Python SDK](../../../../cn.zh-CN/SDK 参考/Python SDK.md#)、[PyODPS DataFrame自定义函数中使用第三方包](../../../../cn.zh-CN/SDK 参考/PyODPS DataFrame自定义函数中使用第三方包.md#)|
