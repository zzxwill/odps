...
## 2018年10月15日-新增project的setproject 2.0新类型默认为true {#section_evs_g3h_mfb .section}

从2018年10月15日开始，MaxCompute中创建的新project，`odps.sql.type.system.odps2`属性默认为true，详细的setproject说明请参见[其他操作](../../../../cn.zh-CN/用户指南/常用命令/其他操作.md#)。
