...
该函数用于在一个标准JSON字符串中，按照path抽取指定的字符串。利用GET\_JSON\_OBJECT结合UDTF，您可以轻松转换JSON格式日志数据，详情参见[利用MaxCompute内建函数及UDTF转换JSON格式日志数据](https://yq.aliyun.com/articles/627758)。
