...
本文为您介绍MaxCompute支持CHAR\_MATCHCOUNT、CONCAT、CONCAT等字符串函数。
...
-   path：String类型，用于描述在json中的path，以$开头。关于新实现中json path的说明，请参见：[JsonPath](http://goessner.net/articles/JsonPath/index.html#e2)。
