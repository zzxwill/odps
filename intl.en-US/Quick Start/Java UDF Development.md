...
-   Using [MaxCompute Studio completes Java UDF development throughout the process](../../../../intl.en-US/Tools and Downloads/MaxCompute Studio/Developing Java/Develop and debug UDF.md).
-   Use the [develop and debug JAVA UDF with Eclipse plug-ins](../../../../intl.en-US/Tools and Downloads/Eclipse Plugins/UDF.md), export jar packages, then use the command or DataWorks to [add the resource](../../../../intl.en-US/User Guide/Common commands/Resource.md) and then [register the function](../../../../intl.en-US/User Guide/Common commands/Function Operations.md).
...
-   For related statements about custom function registration and logout, and viewing function list, see [function](../../../../intl.en-US/User Guide/Common commands/Function Operations.md).
-   For the data types mapping for Java and MaxCompute, see [parameters and return types](../../../../intl.en-US/User Guide/SQL/UDF/Java UDF.md).

## UDF Examples {#section_q5g_1zy_5db .section}
...
-   **Developing using MaxCompute Studio**
    1.  **Prepare tools and environment**.
        ...
        Suppose that the environment has been prepared, which includes [installing Studio](../../../../intl.en-US/Tools and Downloads/MaxCompute Studio/Tools Installation and version history/Install IntelliJ IDEA.md), creating a [MaxCompute project link](../../../../intl.en-US/Tools and Downloads/MaxCompute Studio/Project space connection management.md) on Studio, and creating a [MaxCompute Java module](../../../../intl.en-US/Tools and Downloads/MaxCompute Studio/Developing Java/Create MaxCompute Java Module.md).

    2.  **Write program**.

        Create a Java file under the configured Java Module.

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11953/1573_en-US.png)
        ...
        **Note:** If you want to debug Java locally UDF, see [develop and debug UDF](../../../../intl.en-US/Tools and Downloads/MaxCompute Studio/Developing Java/Develop and debug UDF.md)
    ...
    3.  **Register MaxCompute UDF**.
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11953/1574_en-US.png)
    ...
    4.  **Try the UDF**.
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11953/1575_en-US.png)

        **Note:** To write SQL scripts in Studio, see [writing SQL scripts](../../../../intl.en-US/Tools and Downloads/MaxCompute Studio/Develop SQL procedure/Write SQL scripts.md).

-   **Developing using the Eclipse plug-in**
    1.  **Creating a Project**

        Suppose that a MaxCompute \(formerly ODPS\) project has been created in the Eclipse plug-in, for more information, see [creating a MaxCompute project](../../../../intl.en-US/Tools and Downloads/Eclipse Plugins/Create a project.md).
    ...
    2.  **Writing program**
        ...
        **Note:** 
        ...
        -   For more detailed introduction of developing debugging code, see [UDF](../../../../intl.en-US/Tools and Downloads/Eclipse Plugins/UDF.md).
        -   For more information about the SDK, see [UDF SDK](../../../../intl.en-US/User Guide/SQL/UDF/UDF Summary.md) .
    3.  **Add Resource：**
        ...
        **Note:** MaxCompute [MapReduce](../../../../intl.en-US/User Guide/MapReduce/Summary/MapReduce.md) also describes the use of resources.
...
## UDAF Examples {#section_zvj_3bz_5db .section}

The registration method for a UDAF is similar to for a UDF. Its use is consistent with the [Aggregation Function](../../../../intl.en-US/User Guide/SQL/Builtin Function/Aggregate function.md).  The following example shows a UDAF code to calculate the average:
