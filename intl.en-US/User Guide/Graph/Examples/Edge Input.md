# Edge Input {#concept_srd_3dn_vdb .concept}
...
public class VertexInputFormat {
  ...
  If (ARGs. Length <4 ){
     ...
     * 3. Specify the data loading phase, and generate the vertex that participates in calculation.  Similar to reduce, edges generated by map are combined to a vertex.
