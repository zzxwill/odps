...
For a detailed example, see [Program examples](reseller.en-US/User Guide/MapReduce/Program Example/WordCount samples.md).
...
For more information, see [SecondarySort Example](reseller.en-US/User Guide/MapReduce/Program Example/Secondary Sort samples.md).
...
For more information, see [WordCount code examples](reseller.en-US/User Guide/MapReduce/Program Example/WordCount samples.md).
