...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11949/15409762481423_zh-CN.png)
...
-   SDK连接MaxCompute配置。请参见[Java SDK](../../../../intl.zh-CN/用户指南/SDK/Java SDK.md#)和[Python SDK](../../../../intl.zh-CN/用户指南/SDK/Python SDK.md#)连接MaxCompute接口配置。
