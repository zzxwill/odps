...
1.  **新增一个module:** 参考[创建MaxCompute java module](intl.zh-CN/工具及下载/MaxCompute Studio/开发 SQL 程序/创建 MaxCompute Script Module.md#)，我们的UDF代码将放置在此module中。
2.  **开发UDF:** 参考[UDF开发](intl.zh-CN/工具及下载/MaxCompute Studio/开发 Java 程序/开发和调试UDF.md#) studio提供了UDF开发模板，你可以依据模板完成UDF开发。
