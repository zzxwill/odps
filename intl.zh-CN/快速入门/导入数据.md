...
4.  执行成功后，查看表wc\_in的记录。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11951/15444242791484_zh-CN.png)
...
2.  创建MaxCompute表。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11951/15444242791490_zh-CN.png)
...
3.  上传数据文件。
    ...
    **说明：** 如果新建表未显示，请单击**刷新**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11951/15444242791522_zh-CN.png)
...
5.  编译与运行。
    ...
    1.  右键单击**java工程**并导航至**Import** \> **Maven** \> **Existing Maven Projects**， 设置如下：
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11951/15444242791545_zh-CN.PNG)

    2.  右键单击**UploadSample.java**并单击**Run As** \> **Run Configurations**，如下所示：

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11951/15444242791547_zh-CN.PNG)
